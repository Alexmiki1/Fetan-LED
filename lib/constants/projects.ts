...
export const PROJECTS: Project[] = [
  ...
  {
    id: "5",
    title: "40 m² Indoor P2.5 LED Video Wall",
    subtitle: "Ultra-high-definition visual experience with 8K content capability",
    category: "indoor",
    size: "40 SQM",
    featured: true,
    span: "large",
    image: "/images/projects/indoor-p25-40sqm.jpg",
  },
  {
    id: "6",
